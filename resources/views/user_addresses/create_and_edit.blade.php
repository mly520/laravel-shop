            ...
            <div class="card">
                ...
                <!-- 输出后端报错结束 -->
                    ...
                    <user-addresses-create-and-edit inline-template>
                        ...
                        {{ csrf_field() }}
                        <!-- 注意这里多了 @change -->
                            <select-district :init-value="{{ json_encode([old('province', $address->province), old('city', $address->city), old('district', $address->district)]) }}" @change="onDistrictChanged" @change="onDistrictChanged" inline-template>
